...
document.querySelector('.data-notice').innerHTML='<span id="data-status" role="status">Загрузка…</span> <button id="refresh-data" style="color:#293870;text-decoration:underline;text-underline-offset:2px">Обновить ↻</button><details><summary>Об источнике и обновлении</summary>The Odds · букмекеры США, Европы, Великобритании и Австралии. Частоту автообновления задаёт администратор. После входа отдельный бой можно обновить стрелочкой. Открытый экран проверяет наш сервер каждую минуту. <span style="color:#258753">(▲</span> Рост<span style="color:#258753">)</span> · <span style="color:#98536f">(▼</span> Снижение<span style="color:#98536f">)</span> относительно предыдущего полученного значения той же БК. Баланс условный. Ставки не отправляются букмекерам, пополнение и вывод денег не подключены. Время боёв — по поставщику, МСК, может уточняться. Исход — победитель, тотал — больше/меньше числа раундов. Прочерк — котировки нет. <a href="https://the-odds-api.com/" target="_blank" rel="noopener noreferrer" style="color:#293870;font:inherit;text-decoration:underline;text-underline-offset:2px" title="Открыть сайт поставщика коэффициентов">The Odds ↗</a></details>';
